...
#include "../features/trigger/trigger.h"
...
void H::Hooks::init() {
	...
	oGetLocalController = reinterpret_cast<decltype(oGetLocalController)>(M::patternScan("client", "48 8B 0D ? ? ? ? 48 8D 54 24 30 48 8B 01 FF 90 ? ? ? ?")); 

	StartTriggerbotThread();
